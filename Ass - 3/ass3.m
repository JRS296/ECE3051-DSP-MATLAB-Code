%Task - 3: Realization of OFDM Waveforms
%Name: Jonathan Rufus Samuel (20BCT0332)
%Course: ECE3051 - ELA

%For the given OFDM system, generate the waveforms corresponding to each
%block.
...
%2) Signal after QPSK/QAM modulation transform (here choose QAM)
fs = 20;
t = -50:50;
